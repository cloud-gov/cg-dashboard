...
describe('UserStore', function () {
  ...
  describe('on USER_INVITE_STATUS_DISPLAYED', function() {
    ...
    beforeEach(function() {
      notice = { noticeType: "finish", description: "No verified cloud.gov account was found for undefined, so the user has been sent an email invitation. Their account has been associated to this space, and their space roles can be controlled below.' to equal 'There was no cloud.gov account found for undefined or the user has not verified their account by logging in.They have been sent an email cloud.gov invitation. Their account has been associated to this space and their space roles can be controlled below." };
