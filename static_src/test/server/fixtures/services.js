...
const services = [
  {
    ...
    entity: {
      ...
      extra: "{\"displayName\":\"RDS Database Broker\",\"imageUrl\":\"\",\"longDescription\":\"\",\"providerDisplayName\":\"RDS\",\"documentationUrl\":\"\",\"supportUrl\":\"\"}",
      tags: [
        "database",
        "RDS",
        "postgresql"
  ...
  },
  {
    ...
    entity: {
      ...
      extra: "{\"displayName\":\"Elasticsearch 1.7.1: 3G / 3x CPU\",\"longDescription\":\"A Elasticsearch 1.7.1 service\",\"providerDisplayName\":\"18F\",\"documentationUrl\":\"\",\"supportUrl\":\"\"}",
      tags: [
        "elasticsearch171",
        "elasticsearch",
        "search"
      ...
      plan_updateable: false,
      service_plans_url: "/v2/services/04a366c8-6f52-42e8-9140-97b6fa582c39/service_plans"
    }
  },
  {
    metadata: {
    ...
    entity: {
      ...
      extra: "{\"displayName\":\"Redis 2.8\",\"longDescription\":\"A Redis 2.8 service for development and testing running inside a Docker container\",\"providerDisplayName\":\"Pivotal Software\",\"documentationUrl\":\"http://docs.run.pivotal.io\",\"supportUrl\":\"http://support.run.pivotal.io/home\"}",
      tags: [
        "redis28",
        "redis",
        "key-value"
      ...
      service_broker_guid: "543ecf36-80e4-44fd-906f-e2d4c5fc1d3b",
      plan_updateable: false,
      service_plans_url: "/v2/services/03f26e73-5f2a-445d-af8e-d41502095c87/service_plans"
    }
  },
  {
    metadata: {
    ...
    entity: {
      ...
      bindable: true,
      unique_id: "s3",
      extra: "{\"longDescription\":\"Amazon S3 Service\",\"documentationUrl\":\"http://aws.amazon.com/s3\",\"providerDisplayName\":\"Amazon\",\"displayName\":\"Amazon S3\",\"imageUrl\":\"http://a1.awsstatic.com/images/logos/aws_logo.png\",\"supportUrl\":\"http://aws.amazon.com/s3\"}",
      tags: [
        "s3",
        "object-storage"
      ],
      ...
      plan_updateable: false,
      service_plans_url: "/v2/services/2c0933b1-812d-45ef-97af-6b67b59af337/service_plans"
    }
  },
  {
    metadata: {
    ...
    entity: {
      ...
      plan_updateable: false,
      service_plans_url: "/v2/services/ecdd80c3-0394-4958-9424-f4437a8ad9fa/service_plans"
    }
  },
  {
    metadata: {
    ...
    entity: {
      ...
      extra: "{\"provider\":{\"name\":\"The name\"},\"listing\":{\"imageUrl\":\"http://catgifpage.com/cat.gif\",\"blurb\":\"fake broker that is fake\",\"longDescription\":\"A long time ago, in a galaxy far far away...\"},\"displayName\":\"The Fake Broker\"}",
      tags: [
        "no-sql",
        "relational"
      ],
      ...
      service_plans_url: "/v2/services/101b4967-acd2-4ffc-aa4a-6bc980ed954c/service_plans"
    }
  }
];
