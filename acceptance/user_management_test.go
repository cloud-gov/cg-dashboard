...
var _ = Describe("AppStructure", func() {
	...
	It("Allow the user to modify user permissions for space", func() {
		By("going to the space user management page", func() {
			...
			space.ViewsUserManagementTab()
		})

		By("allowing the user to add and remove a space user", func() {
			space.ToggleUser(testEnvVars.TestOrgName, testEnvVars.Username)
		})
